...
@Getter
public class Pack extends JSONModel {
    ...
    public EmbedBuilder getAsEmbed(JDA jda) {
        ...
        builder.addField("Sell it for", Utilities.money(this.buySum, ""), true);
        builder.addField("Buy it for", Utilities.money(this.buySum, ""), true);
